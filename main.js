class Slider {
    ...
    constructor(config) {
        ...
        this.interval = isNaN(config.interval) == true ? this.timeMove + 1000 : config.interval < this.timeMove + 1000 ? console.error(" Interval 'time' dan kichik bo'lmaydi!!!"): config.interval
